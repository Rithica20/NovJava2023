public class DataTypesConcept {
    public static void main(String[] args) {
        //main difference between primitive and non-primitive data types is that primitive data types represent
        // simple values directly, while non-primitive data types represent objects
        // that are stored in memory and hold references to the data.
